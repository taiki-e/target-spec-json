...
const _: fn() = || {
    ...
    assert_send::<crate::target_spec::TargetArch>();
    assert_sync::<crate::target_spec::TargetArch>();
    assert_unpin::<crate::target_spec::TargetArch>();
    assert_unwind_safe::<crate::target_spec::TargetArch>();
    assert_ref_unwind_safe::<crate::target_spec::TargetArch>();
    assert_send::<crate::target_spec::TargetOs>();
    assert_sync::<crate::target_spec::TargetOs>();
    assert_unpin::<crate::target_spec::TargetOs>();
    assert_unwind_safe::<crate::target_spec::TargetOs>();
    assert_ref_unwind_safe::<crate::target_spec::TargetOs>();
    assert_send::<crate::target_spec::TargetEnv>();
    assert_sync::<crate::target_spec::TargetEnv>();
    assert_unpin::<crate::target_spec::TargetEnv>();
    assert_unwind_safe::<crate::target_spec::TargetEnv>();
    assert_ref_unwind_safe::<crate::target_spec::TargetEnv>();
